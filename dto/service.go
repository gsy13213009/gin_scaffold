...
type ServiceAddInput struct {
	...
	RuleType               int8   `json:"rule_type" form:"rule_type" example:"" validate:"" comment:"匹配类型 0=url前缀url_prefix 1=域名domain"`
	Rule                   string `json:"rule" form:"rule" example:"" validate:"required" comment:"type=domain表示域名，type=url_prefix时表示url前缀"`
	NeedHttps              int8   `json:"need_https" form:"need_https" example:"" validate:"" comment:"支持https 1=支持'"`
	NeedStripUri           int8   `json:"need_strip_uri" form:"need_strip_uri" example:"" validate:"" comment:"启用strip_uri 1=启用'"`
	NeedWebsocket          int8   `json:"need_websocket" form:"need_websocket" example:"" validate:"" comment:"是否支持websocket 1=支持'"`
	...
	OpenAuth               int    `json:"open_auth" form:"open_auth" example:"" validate:"" comment:"是否开启权限"`
	...
	ClientipFlowLimit      int64  `json:"clientip_flow_limit" form:"clientip_flow_limit" example:"" validate:"" comment:"客户端ip限流"`
	ServiceFlowLimit       int64  `json:"service_flow_limit" form:"service_flow_limit" example:"" validate:"" comment:"服务端限流"`
	RoundType              int8   `json:"round_type" form:"round_type" example:"" validate:"" comment:"轮询方式 0=random 1=round-robin 2=weight_round-robin 3=ip_hash"`
...
type ServiceUpdateInput struct {
	ID                     int64  `json:"id" form:"id" comment:"服务id" validate:"required" example:"62"`
	ServiceName            string `json:"service_name" form:"service_name" validate:"required,is_valid_service_name" example:"hhhhh_服务名字"`
	ServiceDesc            string `json:"service_desc" form:"service_desc" validate:"required,max=255,min=1"`
	RuleType               int8   `json:"rule_type" form:"rule_type" example:"" validate:"" comment:"匹配类型 0=url前缀url_prefix 1=域名domain"`
	Rule                   string `json:"rule" form:"rule" example:"" validate:"required" comment:"type=domain表示域名，type=url_prefix时表示url前缀"`
	NeedHttps              int8   `json:"need_https" form:"need_https" example:"" validate:"" comment:"支持https 1=支持'"`
